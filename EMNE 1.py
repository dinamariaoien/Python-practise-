...
# Statisk data
print ("name:", "Sara", "Age:", "25")
print("My name is Dina\nI am 24 years old\nI live in Oslo") # /n deler opp i linjer

print("*" * 30) # Multiplisere
print("Name:", "Sara")
print("Age:", "25")
print("*" * 30)
...
print("Hello " + name + "!" + " " + "You are " + age + " " + "years old and live in " + adress +".")
...
print(name[-1])   # 'n'  (last character, index -1)

# slicing sequence[start:stop:step]
word = "Programming"
print(word[0:3])   # 'Pro'   — characters at index 0, 1, 2
print(word[:4])    # 'Prog'  — from the start up to (not including) index 4
print(word[4:])    # 'ramming' — from index 4 to the end
print(word[-3:])   # 'ing'   — the last 3 characters
print(word[0:6:2]) # 'Pga'   — every 2nd character from index 0 to 6
...
word = "Python"
print(word[::-1])  # 'nohtyP'  — negative step walks backwards

numbers = [1, 2, 3, 4, 5]
print(list(reversed(numbers)))   # [5, 4, 3, 2, 1] — reversed() works on any sequence

numbers.reverse()   # reverses the list in place, no new list created
print(numbers)      # [5, 4, 3, 2, 1]

# Palindrome - same word both ways RADAR ex.
text = input("Enter a word: ").lower()  # . lower Gjør alle bokstavene i teksten om til små bokstaver.
if text == text[::-1]:
...
# Chained Comparisons
age = 20
print(18 <= age <= 65)   # True — same as: 18 <= age and age <= 65
...
day = "Saturday"
if day in ["Saturday", "Sunday"]:  #  Lists ([ ]), "is this value one of several options?"
    print("It is the weekend.")
